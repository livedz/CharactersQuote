        ...
        GeometryReader { geo in
            ScrollViewReader { proxy in
                ZStack(alignment: .top) {
                    ...
                    ScrollView {
                        TabView {
                            if let charImages = character.images, !charImages.isEmpty {
                                ForEach(charImages, id: \.self) { charImage in
...
#Preview {
    CharacterView(character: ViewModel().character, showType: TabDetails(type: .elCamino))
}
